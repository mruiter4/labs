#sentence 
    #choose a link that starts with a capitalized letter - if string.startswith()
    #continue until word added has punctuation. -if string.endswith()

#paragraph = string together n sentences
